...
[![Docker Hub](https://img.shields.io/docker/pulls/bitdruid/llm-manager-ui?logo=docker&logoColor=white&label=docker%20pulls)](https://hub.docker.com/r/bitdruid/llm-manager-ui)
...
Pull the prebuilt image from [Docker Hub](https://hub.docker.com/r/bitdruid/llm-manager-ui):
```bash
docker pull bitdruid/llm-manager-ui:latest
```
